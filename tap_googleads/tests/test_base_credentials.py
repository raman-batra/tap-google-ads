...
class TestTapGoogleadsWithBaseCredentials(unittest.TestCase):
    ...
    def test_base_credentials_discovery(self):
        ...
        self.assertEqual(len(catalog), 14, "Total streams from default catalog")
    ...
    # Legacy tests depending on customer_id/customer_ids have been removed because the tap now only supports locations[] or login_customer_id
